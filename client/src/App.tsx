...
import ComingSoon, { getIsUnlocked, setUnlocked } from "@/pages/coming-soon";
...
function ComingSoonGate() {
  const [unlocked, setUnlockedState] = useState(() => getIsUnlocked());
...
function Router() {
  return (
    <Switch>
      {/* Public routes — / shows Coming Soon until passcode "Gen11" is entered */}
      <Route path="/" component={ComingSoonGate} />
