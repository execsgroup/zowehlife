  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight" data-testid="text-page-title">Contact Requests</h1>
          <p className="text-muted-foreground">
            View contact messages submitted for your ministry
          </p>
        </div>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Messages from people who want to connect with your ministry
                </CardDescription>
              </div>
            </div>
          </CardHeader>
